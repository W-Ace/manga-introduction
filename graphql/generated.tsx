...
export type GetAnimateQueryVariables = Exact<{
  id?: InputMaybe<Scalars['Int']>;
  page?: InputMaybe<Scalars['Int']>;
  perPage?: InputMaybe<Scalars['Int']>;
  search?: InputMaybe<Scalars['String']>;
...
/**
 * __useGetAnimateQuery__
 *
 * To run a query within a React component, call `useGetAnimateQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAnimateQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAnimateQuery({
 *   variables: {
 *      id: // value for 'id'
 *      page: // value for 'page'
 ...
 * });
 */
export function useGetAnimateQuery(baseOptions?: Apollo.QueryHookOptions<GetAnimateQuery, GetAnimateQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAnimateQuery, GetAnimateQueryVariables>(GetAnimateDocument, options);
      }
export function useGetAnimateLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAnimateQuery, GetAnimateQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAnimateQuery, GetAnimateQueryVariables>(GetAnimateDocument, options);
        }
export type GetAnimateQueryHookResult = ReturnType<typeof useGetAnimateQuery>;
export type GetAnimateLazyQueryHookResult = ReturnType<typeof useGetAnimateLazyQuery>;
export type GetAnimateQueryResult = Apollo.QueryResult<GetAnimateQuery, GetAnimateQueryVariables>;